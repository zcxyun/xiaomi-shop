<template>
  <div>
    ...
    <div class="home-header">
      ...
      >
        <cube-tab-bar v-model="tabBarselectedLabel" show-slider>
          <cube-tab
        ...
        <div class="navi-panel" v-show="showNaviPanel">
          ...
          <div class="navi-panel-item-wrapper">
            <div class="navi-panel-item"
              ...
              :key="item.label"
            >
              <div :class="naviPanelSelectedlabel === item.label ?
...
export default {
  ...
  data () {
    return {
      showMask: false,
      naviPanelSelectedlabel: this.naviBars[0] || '推荐',
      showNaviPanel: false,
      tabBarselectedLabel: this.naviBars[0] || '推荐'
    }
  },
  computed: {
  },
  ...
  methods: {
    ...
    onNaviClick (label) {
      this.naviPanelSelectedlabel = label
    },
    onShadeMaskClick () {
      this.$refs.arrow.classList.toggle('rotate')
